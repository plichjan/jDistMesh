...
println("Running herodes03...")
herodes("herodes03", box,
    DPoly(listOf(Pnt(30.0, 30.0), Pnt(130.0, 30.0), Pnt(130.0, 50.0), Pnt(50.0, 50.0), Pnt(50.0, 130.0), Pnt(30.0, 130.0))),
    DCircle(200.0, 120.0, 50.0),
    listOf(Pnt(30.0, 30.0), Pnt(130.0, 30.0), Pnt(130.0, 50.0), Pnt(50.0, 50.0), Pnt(50.0, 130.0), Pnt(30.0, 130.0))
)
println("Done.")
